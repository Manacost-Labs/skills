...
description: Engineering guidance from the compact designing-data-intensive-applications rule set. Use it when the task needs this design or delivery lens.
---
