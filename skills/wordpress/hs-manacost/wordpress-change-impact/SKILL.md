...
1. Start with `hs-manacost-project` and a clean understanding of source/runtime/data boundaries.
...
- Production and mirror impact always preserves `.ru` as canonical and `.com` as the noindex mirror.
...
- Newspaper parent-theme, plugin package, nginx, workflow and deployment changes stay separate when rollback differs.
