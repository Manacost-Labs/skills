...
description: Engineering guidance from the compact patterns-of-enterprise-application-architecture rule set. Use it when the task needs this design or delivery lens.
---
