...
description: Enforce clean, secure, maintainable first-party WordPress code in kolodahearthstone.com. Use for every PHP, JavaScript, CSS, MU-plugin, hook, REST/AJAX, cron, WP-CLI, theme integration, refactor, review, or static-analysis change; pair with blocksy-theme whenever Blocksy or Blocksy behavior is involved.
---

# WordPress Clean Code

Keep new code simple and verifiable without rewriting legacy, vendor, commercial plugin, or Blocksy parent-theme code as collateral work.
...
6. Run WPCS, PHPCompatibilityWP, and PHPStan through `make code-quality`. Do not edit generated caches, vendor packages, commercial plugins, or the Blocksy parent theme to satisfy a tool.
...
- Use `blocksy-theme` before any Blocksy, Blocksy Composer, Cloud Template, module, block, Theme API, parent-theme, or theme CSS change.
...
- Do not patch `wordpress/themes/Blocksy` or `td-*` plugin internals as the default solution.
