...
description: Measure and report health, availability, latency, errors, capacity, cron, queues, PHP-FPM, MariaDB, WordPress, cache, S3 offload, image optimization, backups, Cloudflare, and regional proxies for hs-manacost.ru. Use for health reports, monitoring design, performance diagnosis, capacity alerts, SLOs, post-release observation, and recurring operational checks.
---
...
1. Use `hs-manacost-project`; add `wordpress-runtime-stack` for cache/runtime and `wordpress-media-integrity` for media.
...
- availability/status and latency for `hs-manacost.ru`, `hs-manacost.com`, `test.hs-manacost.ru`, origin, Moscow and Novosibirsk;
