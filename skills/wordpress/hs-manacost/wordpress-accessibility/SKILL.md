...
description: Design, review, and test accessible WordPress frontend, Newspaper/tagDiv, article editor, and wp-admin interfaces for hs-manacost.ru. Use for navigation, forms, dialogs, tables, media, keyboard behavior, focus, headings, contrast, zoom, responsive layout, screen-reader names, error states, and WCAG-oriented regression checks on desktop and mobile.
---

# WordPress Accessibility

Treat accessibility as functional behavior, not a visual afterthought. Pair this skill with `hs-manacost-project`, `wordpress-admin-ui` or `newspaper-tagdiv`, and `playwright` for browser evidence.
...
Read [references/newspaper-admin-patterns.md](references/newspaper-admin-patterns.md) before changing Newspaper navigation, article layouts, Composer blocks, editor panels or admin tables.
