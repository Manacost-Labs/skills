...
description: Engineering guidance from the compact working-effectively-with-legacy-code rule set. Use it when the task needs this design or delivery lens.
---
