...
1. Use `kolodahearthstone-project` and take its context snapshot.
...
- Keep `kolodahearthstone.com` canonical, `kolodahearthstone.ru` a one-hop legacy redirect, and `test.kolodahearthstone.com` isolated/noindex.
