...
description: Plan, gate, deploy, verify, promote, and roll back KolodaHearthstone WordPress releases across GitHub, isolated CI, test.kolodahearthstone.com, kolodahearthstone.com, kolodahearthstone.ru, origin, Cloudflare, and Moscow/Novosibirsk proxies. Use for pull requests, staging deployments, production promotions, configuration releases, hotfixes, plugin/theme updates, and release readiness decisions.
---
...
1. Use `kolodahearthstone-project`, `agent-ci-cd-and-automation`, `agent-shipping-and-launch` and the specialist skill for the changed subsystem.
...
7. Merge to `main`; allow the pipeline to deploy the resulting exact SHA only to `test.kolodahearthstone.com`.
...
- Blocksy/Blocksy and commercial plugins remain manual-only and require integration plus visual regression review.
- Never enable production auto-update for commercial plugins or Blocksy.
